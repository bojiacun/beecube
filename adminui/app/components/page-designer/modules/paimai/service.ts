...
export async function getPagedArticle(type: number, classId = '', postFlag = 1,count:number) {
    return axios.get('/paimai/articles/diy/list', { params: {type: type, pageSize: count, classId: classId, postFlag:postFlag}});
}
