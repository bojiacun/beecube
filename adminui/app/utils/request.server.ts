...
export const API_SYS_DICTS = `${BASE_URL}/paimai/coupons/dicts`;
...
export const API_APP_WXOPEN_SETTING_LIST = `${BASE_URL}/beecube-app/app/wxopen/configs/list`;
export const API_APP_TENCENT_SETTING_LIST = `${BASE_URL}/beecube-app/app/tencent/configs/list`;
...
export const API_APP_WXOPEN_SETTINGS_UPDATE = `${BASE_URL}/beecube-app/app/wxopen/configs/updateAll`;
export const API_APP_TENCENT_SETTINGS_UPDATE = `${BASE_URL}/beecube-app/app/tencent/configs/updateAll`;
export const API_APP_MEMBER_LIST = `${BASE_URL}/beecube-app/app/members/list`;
export const API_APP_MEMBER_DETAIL = `${BASE_URL}/beecube-app/app/members/queryById`;
...
export const API_APP_MENU_EDIT= `${BASE_URL}/beecube-app/app/menus/edit`;
export const API_APP_MENU_DELETE = `${BASE_URL}/beecube-app/app/menus/delete`;
...
export const API_PAIMAI_LIVE_GOODS_END = `${BASE_URL}/paimai/rooms/goods/down`;
...
export const API_PAIMAI_BIDDER_LIST = `${BASE_URL}/paimai/bidders/list`;
export const API_PAIMAI_BIDDER_ADD = `${BASE_URL}/paimai/bidders/add`;
export const API_PAIMAI_BIDDER_EDIT= `${BASE_URL}/paimai/bidders/edit`;
export const API_PAIMAI_BIDDER_DELETE = `${BASE_URL}/paimai/bidders/delete`;

export const API_PAIMAI_BANK_LIST = `${BASE_URL}/paimai/banks/list`;
export const API_PAIMAI_BANK_ADD = `${BASE_URL}/paimai/banks/add`;
...
export const API_PAIMAI_COLLECT_LIST = `${BASE_URL}/paimai/collects/list`;
...
export const API_PAIMAI_SMT_SEND = `${BASE_URL}/paimai/smts/send`;
...
export const API_PAIMAI_LIVEROOM_START_NOW = `${BASE_URL}/paimai/rooms/start`;
...
export const API_PAIMAI_INTEGRAL_ORDER_LIST = `${BASE_URL}/paimai/integral/orders/list`;
