...
import TenantEdit from "~/pages/system/tenants/TenantEdit";
...
const TenantList = (props: any) => {
        ...
        switch (e) {
            ...
            case 'delete':
                ...
                showDeleteAlert(function () {
                    startPageLoading();
                    deleteFetcher.submit({id: row.id}, {method: 'delete', action: `/system/tenants/delete?id=${row.id}`, replace: true});
                });
                break;
        }
    }
    ...
    return (
        <>
                ...
                <div className={'m-2'}>
                    <Row>
                        <Col md={6} className={'d-flex align-items-center justify-content-start mb-1 mb-md-0'}>
                            ...
                            />
                            <Button onClick={handleOnAdd} className={'mr-1'}><i className={'feather icon-plus'} />新建租户</Button>
                        </Col>
                        <Col md={6} className={'d-flex align-items-center justify-content-end'}>
                            <searchFetcher.Form className={'form-inline justify-content-end'} onSubmit={handleOnSearchSubmit}>
                                ...
                                <FormGroup as={Form.Row} className={'mb-0'}>
                                    <FormLabel htmlFor={'name'}>租户名称</FormLabel>
                                    <Col>
                                        <InputGroup>
            ...
            {editModal && <TenantEdit model={editModal} onHide={()=>{
                setEditModal(null);
                loadData();
            }} />}
        </>
