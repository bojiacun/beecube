        ...
        switch (e) {
            ...
            case 'delete':
                ...
                showDeleteAlert(function () {
                    startPageLoading();
                    deleteFetcher.submit({id: row.id}, {method: 'delete', action: `/paimai/banks/delete?id=${row.id}`, replace: true});
                });
                break;
        }
    }
                ...
                <div className={'m-2'}>
                    <Row>
                        <Col md={6} className={'d-flex align-items-center justify-content-start mb-1 mb-md-0'}>
                            ...
                            />
                            <Button onClick={handleOnAdd}><i className={'feather icon-plus'} />新建银行卡</Button>
                        </Col>
                    </Row>
                </div>
