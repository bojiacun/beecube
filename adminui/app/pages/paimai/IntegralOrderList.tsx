...
const IntegralOrderList = (props: any) => {
        ...
        switch (e) {
            ...
            case 'confirm-pay':
                ...
                showDeleteAlert(function () {
                    startPageLoading();
                    deleteFetcher.submit({id: row.id}, {method: 'put', action: `/paimai/integral/orders/confirm_pay?id=${row.id}`, replace: true});
                }, '此订单确认已经支付了吗？', '确认支付');
                break;
            case 'confirm-delivery':
                ...
                showDeleteAlert(function () {
                    startPageLoading();
                    deleteFetcher.submit({id: row.id}, {method: 'put', action: `/paimai/integral/orders/confirm_delivery?id=${row.id}`, replace: true});
                }, '此订单确认已经收货了吗？', '确认收货');
                break;
        }
    }
...
export default IntegralOrderList;