...
const LiveRoomDepositList = (props: any) => {
    const {show, onHide, selectedRow} = props;
    const [list, setList] = useState<any>({records: []});
    const [searchState, setSearchState] = useState<any>({...DefaultListSearchParams, roomId: selectedRow.id});
    ...
    return (
        ...
        >
            <Modal.Header closeButton>
                <Modal.Title id={'edit-modal'}>直播间保证金记录</Modal.Title>
            </Modal.Header>
            <Modal.Body>
                <div className={'m-2'}>
                    <Row>
                        ...
                        <Col md={6} className={'d-flex align-items-center justify-content-end'}>
                            <searchFetcher.Form action={'/paimai/deposits'} className={'form-inline justify-content-end'}
                                ...
                                <FormControl name={'performanceId'} value={selectedRow.id} type={'hidden'}/>
...
export default LiveRoomDepositList;