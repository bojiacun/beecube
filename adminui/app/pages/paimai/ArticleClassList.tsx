...
import ArticleClassEditor from "~/pages/paimai/ArticleClassEditor";


const ArticleClassList = (props: any) => {
    ...
    return (
        <>
                ...
                <div className={'m-2'}>
                    <Row>
                        <Col md={6} className={'d-flex align-items-center justify-content-start mb-1 mb-md-0'}>
                            ...
                            />
                            <Button onClick={handleOnAdd}><i className={'feather icon-plus'} />新建文章分类</Button>
                        </Col>
            ...
            {editModal && <ArticleClassEditor model={editModal} onHide={()=>{
                setEditModal(null);
                loadData();
            }} />}
        </>
...
export default ArticleClassList;