...
const GoodsClassList = (props: any) => {
        ...
        switch (e) {
            ...
            case 'delete':
                ...
                showDeleteAlert(function () {
                    startPageLoading();
                    deleteFetcher.submit({id: row.id}, {method: 'delete', action: `/paimai/goods/classes/delete?id=${row.id}`, replace: true});
                });
                break;
        }
    }
    ...
    return (
        <>
                ...
                <div className={'m-2'}>
                    <Row>
                        <Col md={6} className={'d-flex align-items-center justify-content-start mb-1 mb-md-0'}>
                            ...
                            />
                            <Button onClick={handleOnAdd}><i className={'feather icon-plus'} />新建拍品分类</Button>
                        </Col>
            ...
            {editModal && <GoodsClassEditor model={editModal} onHide={()=>{
                setEditModal(null);
                loadData();
            }} />}
        </>
