...
const BuyoutClassSchema = Yup.object().shape({
    name: Yup.string().required('必填字段'),
});

const BuyoutClassEditor = (props: any) => {
    ...
    const handleOnSubmit = (values: any) => {
        if (values.id) {
            postFetcher.submit(values, {method: 'post', action: '/paimai/buyout/classes/edit'});
        } else {
            postFetcher.submit(values, {method: 'post', action: '/paimai/buyout/classes/add'});
        }
    }
...
export default BuyoutClassEditor;