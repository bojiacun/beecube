...
const PerformancesListSelected = (props: any) => {
    ...
    return (
        ...
        >
                        ...
                        <Col md={6} className={'d-flex align-items-center justify-content-end'}>
                            <searchFetcher.Form action={'/paimai/goods/auction'} className={'form-inline justify-content-end'}
                                ...
                                <FormGroup as={Row} className={'mb-0'}>
                                    <FormLabel column htmlFor={'title'}>专场名称</FormLabel>
                                    <Col md={'auto'}>
                                        <InputGroup>
            ...
            <Modal.Footer>
                <Button variant={'danger'} onClick={handleOnRemovePerformances} disabled={removeFetcher.state === 'submitting'}>确认移除</Button>
            </Modal.Footer>
        </Modal>
    );
}
