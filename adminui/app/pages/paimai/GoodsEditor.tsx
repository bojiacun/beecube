...
const GoodsEditor = (props: any) => {
    ...
    const GoodsSchema = Yup.object().shape({
        ...
        endTime: Yup.date().required('必填字段'),
                            ...
                            return (
                                <Form method={'post'}>
                                    <Modal.Body style={{maxHeight: 'calc(100vh - 200px)', overflowY: 'auto'}}>
                                        ...
                                        <FormGroup>
                                            <FormLabel htmlFor={'avatar'}>拍品图片</FormLabel>
                                            <FileBrowserInput name={'avatar'} type={1} multi={true} />
                                        </FormGroup>
                                        <FormGroup>
                                        ...
                                        <BootstrapInput label={'保证金'} name={'deposit'} />
                                        <BootstrapInput label={'延时周期'} name={'delayTime'} />
