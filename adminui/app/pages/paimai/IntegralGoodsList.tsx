...
const TOGGLE_STATUS_URL = '/paimai/integral/goods/toggle-show';

const IntegralGoodsList = (props: any) => {
    ...
    const operateBatch = () => {
        deleteFetcher.submit({status: operateValue, rows: selectedRows.join(',')}, {method: 'delete', action: TOGGLE_STATUS_URL, replace: true});
    }
    return (
        <>
            <Card>
                <div className={'m-2'}>
                    <Row>
                        <Col md={6} className={'d-flex align-items-center justify-content-start mb-1 mb-md-0'}>
                            ...
                            />
                            <Button onClick={handleOnAdd}><i className={'feather icon-plus'}/>新建积分商品</Button>
                        </Col>
                        <Col md={6} className={'d-flex align-items-center justify-content-end'}>
                            <searchFetcher.Form className={'form-inline justify-content-end'} onSubmit={handleOnSearchSubmit}>
                                ...
                                <FormGroup as={Row} className={'mb-0'}>
                                    <FormLabel column htmlFor={'name'}>商品名称</FormLabel>
                                    <Col md={'auto'}>
                                        <InputGroup>
...
export default IntegralGoodsList;