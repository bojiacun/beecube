        ...
        switch (e) {
            ...
            case 'delete':
                ...
                showDeleteAlert(function () {
                    startPageLoading();
                    deleteFetcher.submit({id: row.id}, {method: 'delete', action: `/paimai/collects/delete?id=${row.id}`, replace: true});
                });
                break;
        }
    }
    ...
    const columns: ColumnDescription[] = [
        ...
        },
        {
            ...
            formatter: (cell: any, row: any) => {
                ...
                return <a href={previewUrl} target={'_blank'}><FigureImage src={previewUrl} style={{width: 60, height: 60}}/></a>;
            }
        },
        {
            text: '联系人',
