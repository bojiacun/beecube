...
import MemberSettingsEditor from "~/pages/app/settings/MemberSettingsEditor";
...
const AppSettingsWechat = () => {
    ...
    appSettings?.filter((s:any) => s.groupKey === 'member').forEach((s:any) => {
        settings[s.settingKey] = s.settingValue;
    });

    return (
        <MemberSettingsEditor settings={settings} />
    );
}
