...
import {API_APP_MODULE_LIST, requestWithToken} from "~/utils/request.server";
...
export const loader: LoaderFunction = async ({request}) => {
    ...
    const result = await requestWithToken(request)(API_APP_MODULE_LIST+ queryString);
    return json(result.result);
}

const AppModulesPage = (props:any) => {
    return <AppModuleList {...props} />
}

export default withPageLoading(AppModulesPage);