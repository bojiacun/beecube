...
import {
    ...
    API_APP_WXOPEN_UPLOAD_CANCEL,
    API_APP_WXOPEN_UPLOAD_PREVIEW,
    API_APP_WXOPEN_UPLOAD_PUBLIC,
    API_APP_WXOPEN_UPLOAD_RELEASE,
    postFormInit,
    requestWithToken
...
export const action: ActionFunction = async ({request}) => {
    ...
    return await requestWithToken(request)(API_APP_WXOPEN_UPLOAD_CANCEL+'?'+url.searchParams.toString(), postFormInit(data));
}
