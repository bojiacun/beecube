...
import {API_PAIMAI_BIDDER_LIST, requestWithToken} from "~/utils/request.server";
import {withPageLoading} from "~/utils/components";
import BidderList from "~/pages/paimai/BidderList";
...
export const loader: LoaderFunction = async ({request}) => {
    ...
    const result = await requestWithToken(request)(API_PAIMAI_BIDDER_LIST + queryString);
