...
import {API_PAIMAI_GOODS_LIST, API_PAIMAI_INTEGRAL_GOODS_LIST, requestWithToken} from "~/utils/request.server";
import {withPageLoading} from "~/utils/components";
import BuyoutList from "~/pages/paimai/BuyoutList";
import IntegralGoodsList from "~/pages/paimai/IntegralGoodsList";
...
export const loader: LoaderFunction = async ({request}) => {
    ...
    const result = await requestWithToken(request)(API_PAIMAI_INTEGRAL_GOODS_LIST+ queryString);
    return json(result.result);
}

const IndexPage = (props:any) => {
    return (
        <IntegralGoodsList {...props} />
    );
}
