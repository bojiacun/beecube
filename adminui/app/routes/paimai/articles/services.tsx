...
export const loader: LoaderFunction = async ({request}) => {
    ...
    url.searchParams.set('type', ArticleType.SERVICES.toString());
    let queryString = '';
...
const NormalArticleListPage = (props:any) => {
    return (
        <ArticleList type={ArticleType.SERVICES} {...props} />
    );
}

export default withPageLoading(NormalArticleListPage);