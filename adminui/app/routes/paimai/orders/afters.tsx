...
import {API_PAIMAI_ORDER_AFTER_LIST, requestWithToken} from "~/utils/request.server";
...
export const loader: LoaderFunction = async ({request}) => {
    ...
    const result = await requestWithToken(request)(API_PAIMAI_ORDER_AFTER_LIST+ queryString);
    return json(result.result);
}

const AfterOrderListPage = (props:any) => {
    return (
        <AfterOrderList {...props} />
    );
}
