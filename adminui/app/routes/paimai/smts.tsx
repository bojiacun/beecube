...
import {API_PAIMAI_SMT_LIST, requestWithToken} from "~/utils/request.server";
import {withPageLoading} from "~/utils/components";
import SmtList from "~/pages/paimai/SmtList";
...
export const loader: LoaderFunction = async ({request}) => {
    ...
    const result = await requestWithToken(request)(API_PAIMAI_SMT_LIST+ queryString);
