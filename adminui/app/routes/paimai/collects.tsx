...
import {API_PAIMAI_COLLECT_LIST, requestWithToken} from "~/utils/request.server";
import {withPageLoading} from "~/utils/components";
import CollectList from "~/pages/paimai/CollectList";
...
export const loader: LoaderFunction = async ({request}) => {
    ...
    const result = await requestWithToken(request)(API_PAIMAI_COLLECT_LIST+ queryString);
