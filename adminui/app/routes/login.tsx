                ...
                <Col lg={4} className="d-flex align-items-center auth-bg px-2 p-lg-5">
                    <Col lg={12} sm={8} md={6} className="px-xl-2 mx-auto">
                        <Card.Title className="mb-1 font-weight-bold" style={{fontSize: '1.714rem'}}>
                            欢迎使用 Rexo Admin Dashboard 管理模板 Vue.js 版 👋
                        </Card.Title>
                        <Card.Text>
                            请登录您的帐户开始体验
                        </Card.Text>
                        <Alert variant='primary' show>
                            ...
                            <OverlayTrigger placement={'top'} overlay={<Tooltip id={'help'}>管理员和客户账号登录后体验不一样哦</Tooltip>}>
                        ...
                        <Form className="auth-login-form mt-2">
                            ...
                            <Button block variant={'primary'} type={'submit'}>登 录</Button>
                        </Form>
                    </Col>
                </Col>
            </Row>
