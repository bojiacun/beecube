...
import {API_USER_DEPARTMENT_LIST_ALL, API_USER_ROLE_LIST_ALL, requestWithToken} from "~/utils/request.server";
...
export const loader: LoaderFunction = async ({request,params}) => {
    ...
    const result = await requestWithToken(request)(API_USER_DEPARTMENT_LIST_ALL + queryString);
