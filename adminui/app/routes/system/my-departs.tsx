...
export const loader: LoaderFunction = async ({request}) => {
    ...
    const result = await requestWithToken(request)(API_SYSDEPART_MY_LIST + queryString);
...
const MyDepartsPage = (props: any) => {
    ...
    return (
        <Row>
            <Col>
                <DepartTreeList showControl={false} departments={departments} {...props} setSelectedDepart={setSelectedDepart} reloadDepartments={reloadDepartments} />
            </Col>
            {selectedDepart && <Col>
...
export default withPageLoading(MyDepartsPage);