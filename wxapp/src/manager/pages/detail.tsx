...
import request, {API_SHOP_GOODS_INFO, resolveUrl, SERVICE_WINKT_SYSTEM_HEADER} from "../../utils/request";
...
const ShopDetail = ({context}) => {
    ...
    return (
        <PageLayout statusBarProps={{title: '图书详情'}}>
                ...
                <>
                    ...
                    <View className="bg-white padding-left-sm padding-right-sm" style={{lineHeight: '48rpx'}}>
                        ...
                        <View className="padding-bottom-sm flex align-center justify-between">
                            ...
                            <Text className="text-gray text-sm">库存：{info.store}</Text>
                        </View>
                    </View>
