...
const ShopGoodsList = () => {
    ...
    const loadData = (class_id = 0, clear = false, page = 1) => {
        ...
        setPage(_page);
        request.get(API_SHOP_GOODS_LIST, SERVICE_WINKT_SYSTEM_HEADER, {page: _page, class_id: class_id, "site_id":0}).then(res=>{
    ...
    useDidShow(()=>{
        ...
        //刷新分类信息
        request.get(API_SHOP_GOODS_CLASSES,SERVICE_WINKT_SYSTEM_HEADER).then(res=>{
    ...
    return (
        <PageLayout showTabBar={true} statusBarProps={{title: '商城图书'}}>
