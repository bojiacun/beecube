...
public class GoodsController extends JeecgController<Goods, IGoodsService> {
	 ...
	 * @return
	 */
	@AutoLog(value = "拍品-分页列表查询")
	@ApiOperation(value="拍品-分页列表查询", notes="拍品-分页列表查询")
	 ...
	 */
	@AutoLog(value = "拍品-添加")
	@ApiOperation(value="拍品-添加", notes="拍品-添加")
	 ...
	 */
	@AutoLog(value = "拍品-编辑")
	@ApiOperation(value="拍品-编辑", notes="拍品-编辑")
	 ...
	 * @return
	 */
	@AutoLog(value = "拍品-通过id删除")
	@ApiOperation(value="拍品-通过id删除", notes="拍品-通过id删除")
	 ...
	 * @return
	 */
	@AutoLog(value = "拍品-批量删除")
	@ApiOperation(value="拍品-批量删除", notes="拍品-批量删除")
	 ...
	 * @return
	 */
	@AutoLog(value = "拍品-通过id查询")
	@ApiOperation(value="拍品-通过id查询", notes="拍品-通过id查询")
  ...
  public ModelAndView exportXls(HttpServletRequest request, Goods goods) {
      return super.exportXls(request, goods, Goods.class, "拍品");
  }
