...
//        tenantTable.add("sys_depart");
        ...
        APP_TABLE.add("beecube_app_publishes");
        APP_TABLE.add("beecube_app_member_withdraws");
        APP_TABLE.add("beecube_app_member_money_records");
        APP_TABLE.add("beecube_app_member_score_records");
